...
- API endpoints: `/health`, `/settings/{key}`, `/channel-groups`, `/auth/telegram/start`, `/auth/telegram/verify-code`, `/auth/telegram/verify-password`, `/openapi.json` (bearer auth required except `/health`).
